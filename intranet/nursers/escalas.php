        ...
        <form>
            ...
            <div id="formEvaluacion">
                <div class="form__field">
                    ...
                    <input type="number" name="enaEva" id="enaEva" value="4">
                </div>

                <div class="form__field">
                    <label for="evera">EVERA</label>
                    <input type="text" name="evera" id="evera" placeholder="Moderado">
                </div>
            ...
            <div id="formPupilar">
                <div class="form__field">
                    ...
                    <input type="number" name="pupilarIzquierda" id="pupilarIzquierda" value="2">
                </div>
                
                <div class="form__field">
                    <label for="pupilarDerecha">Derecha (0 – 10)</label>
                    <input type="number" name="pupilarDerecha" id="pupilarDerecha" value="4">
                </div>
            </div>
            ...
            <div id="formGlasgow">
                <div class="form__field">
                    ...
                    <select name="aperturaDeOjos" id="aperturaDeOjos">
                        <option value="1">Doloroso al estímulo</option>
                        <option value="2">Otro</option>
                    </select>
                </div>
                ...
                <div class="form__field">
                    ...
                    <select name="respuestaMotora" id="respuestaMotora">
                        <option value="1">Retira ante dolor</option>
                        <option value="2">Otro</option>
                    </select>
                </div>
            ...
            <div id="formPerimetros">
                <div class="form__field">
                    ...
                    <select name="ubicacion" id="ubicacion">
                        <option value="1">Abdominal</option>
                        <option value="2">Otro</option>
                    </select>
                </div>
            ...
            <div id="formNorton">
                ...
                <div class="form__field">
                    ...
                    <select name="movilidad" id="movilidad">
                        <option value="1">Muy limitada</option>
                        <option value="2">Otro</option>
                    </select>
                </div>
                <div class="form__field">
                    ...
                    <select name="incontiencia" id="incontiencia">
                        <option value="1">Urinaria</option>
                        <option value="2">Otro</option>
                    </select>
                </div>
                <div class="form__field">
                ...
                <div class="form__field">
                    ...
                    <input type="text" name="escalaDeNorton" id="escalaDeNorton" placeholder="10 = Alto riesgo">
                </div>
            </div>
